            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    <div class="row justify-content-center">
                        ...
                        $cfinal = informacionCompany::getAllJsonAnswers(Conexion::obtener_conexion(), $_SESSION['id']);
                        $cAmbienteTrabajo = informacionCompany::getAllJsonAnswersAllWorkers(Conexion::obtener_conexion(), $_SESSION['id'], [2, 1, 3]);
                        $fPropiosDeActividad = informacionCompany::getAllJsonAnswersAllWorkers(Conexion::obtener_conexion(), $_SESSION['id'], [4, 9, 5, 6, 7, 8, 41, 42, 43, 10, 11, 12, 13, 20, 21, 22, 18, 19, 26, 27]);
                        $oDelTiempoDeTrabajo = informacionCompany::getAllJsonAnswersAllWorkers(Conexion::obtener_conexion(), $_SESSION['id'], [14, 15, 16, 17]);
                        $lYRelacionesDeTrabajo = informacionCompany::getAllJsonAnswersAllWorkers(Conexion::obtener_conexion(), $_SESSION['id'], [23, 24, 25, 28, 29, 30, 31, 32, 44, 45, 46, 33, 34, 35, 36, 37, 38, 39, 40]);

                        $cAmbienteTrabajoDominio = informacionCompany::getAllJsonAnswersAllWorkers(Conexion::obtener_conexion(), $_SESSION['id'], [1, 2, 3]);
                        $cargaTrabajoDominio = informacionCompany::getAllJsonAnswersAllWorkers(Conexion::obtener_conexion(), $_SESSION['id'], [4, 9, 5, 6, 7, 8, 41, 42, 43, 10, 11, 12, 13]);
                        $fControlSobreTrabajoDominio = informacionCompany::getAllJsonAnswersAllWorkers(Conexion::obtener_conexion(), $_SESSION['id'], [20, 21, 22, 18, 19, 26, 27]);
                        $jTrabajoDominio = informacionCompany::getAllJsonAnswersAllWorkers(Conexion::obtener_conexion(), $_SESSION['id'], [14, 15]);
                        $iTrabajofamiliaDominio = informacionCompany::getAllJsonAnswersAllWorkers(Conexion::obtener_conexion(), $_SESSION['id'], [16, 17]);
                        $liderazgoDominio = informacionCompany::getAllJsonAnswersAllWorkers(Conexion::obtener_conexion(), $_SESSION['id'], [23, 24, 25, 28, 29]);
                        $rTrabajoDominio = informacionCompany::getAllJsonAnswersAllWorkers(Conexion::obtener_conexion(), $_SESSION['id'], [30, 31, 32, 44, 45, 46]);
                        $violeciaDominio = informacionCompany::getAllJsonAnswersAllWorkers(Conexion::obtener_conexion(), $_SESSION['id'], [33, 34, 35, 36, 37, 38, 39, 40]);
